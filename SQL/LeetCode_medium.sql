...
`Problem:  All People Report to the Given Manager (WOW Question - Must Practice)
Task: Write an SQL query to find employee_id of all employees that directly or indirectly report their work to the head of the company. 
...
SELECT * FROM ( -- masking
  ...
  FROM
    hierarchy;
  -- Recursive Approach (Any recursion depth - but limiting to 3) -> Recommended (Please learn this!!!)
  WITH RECURSIVE hierarchy AS (
